...
instructions. If you decide _not_ to offer the contest, then do
...
the contest _before_ you build the lab, so that the driver knows the
...
If you decide to offer the contest _after_ you've built and handed out
...
test function against a reference solution for _ALL_ possible input
